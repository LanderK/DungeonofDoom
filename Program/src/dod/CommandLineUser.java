...
public abstract class CommandLineUser implements PlayerListener, Runnable {
	...
	CommandLineUser(GameLogic game,int playerID) {
		this.game = game;
	...
	@Override
	//Sends the Message LOSE to the players that lost 
	...
	public void attackChange(int value){
		outputMessage("ATTMOD " + value, false);
	}
	
	@Override
	public void defenceChange(int value){
		outputMessage("DEFMOD " + value, false);
	}
